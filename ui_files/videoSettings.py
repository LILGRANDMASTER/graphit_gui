...
class Ui_videoSettings(object):
    def setupUi(self, videoSettings):
        ...
        self.layoutWidget = QtWidgets.QWidget(videoSettings)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 401, 88))
        ...
        self.zoomValue = QtWidgets.QSlider(self.layoutWidget)
        self.zoomValue.setMinimum(100)
        self.zoomValue.setMaximum(2000)
        ...
        self.changeView = QtWidgets.QPushButton(self.layoutWidget)
